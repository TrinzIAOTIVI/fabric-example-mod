...
import net.trinity.mccourse.screen.slot.ModFuelSlot;
import net.trinity.mccourse.screen.slot.ModResultSlot;
    ...
    public class DehydratorScreenHandler extends ScreenHandler {
        ...
        public DehydratorScreenHandler(int syncId, PlayerInventory playerInventory, Inventory inventory, PropertyDelegate delegate) {
