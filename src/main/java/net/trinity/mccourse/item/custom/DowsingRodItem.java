package net.trinity.mccourse.item.custom;
...
import net.trinity.mccourse.util.ModTags;
...
public class DowsingRodItem extends Item {
    ...
    private void outputValuableCoordinates(BlockPos positionClicked, PlayerEntity player, Block blockBelow) {
        player.sendMessage(new LiteralText("Found" + blockBelow.asItem().getName().getString()
                + "at" + "(" + positionClicked.getX() + "," + positionClicked.getY() + ","
                + positionClicked.getZ() + ")"), false);
    }
